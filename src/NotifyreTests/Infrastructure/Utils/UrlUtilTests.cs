...
namespace NotifyreTests.Infrastructure.Utils
{
    ...
    {
        [Theory]
        [InlineData(null, "2021-09-01", "2021-09-02", ListSentFaxesRequestSortTypes.Asc, 10,1, "statustype=&fromdate=1630454400&todate=1630540800&search=&sort=asc&limit=10&skip=1")]
